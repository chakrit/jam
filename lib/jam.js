...
module.exports = (function() {
  ...
  function includeHelpers(func) {
    ...
    func.call = function(func) {
      assert(typeof func === 'function', 'function argument missing or not a function');
    ...
    // ## jam.map( array, iterator( next, element ) )
    ...
    func.map = function(array, iterator) {
      assert(array && typeof array === 'object' && typeof array.length === 'number',
        'array argument missing or does not looks like an array');
