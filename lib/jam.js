...
module.exports = (function() {
  ...
  function includeHelpers(func) {
    ...
    //
    // This function only works directly from the JAM export instead of from existing
    // chain as usual. Once called with a JAM chain, a new function will be created and
    // added to the chain and a special callback is for you to supply as callback to
    // existing async calls.
    //
    // The returned callback will have the standard node.js callback signature of
    // (e, args) and will bridge the call into the JAM chain automatically.
